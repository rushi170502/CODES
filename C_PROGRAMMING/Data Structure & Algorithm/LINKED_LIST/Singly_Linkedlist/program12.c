...
// WAP to print the add node at between at any position of the linked list
//
...
// Add node at last position..
   ...
   void  addlast(){// it means also add the node to linked list
...
// add node at first of the linked list
 void addfirst(){
  ...
  void main(){
	  ...
	  addfirst();
	  printf("\nAfter adding node to first of linked list  :");
	 printdata();
	 printf("\n");
	 addlast();
